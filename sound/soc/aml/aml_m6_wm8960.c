...
#if 0
            /* Speaker */
            snd_soc_update_bits(codec, WM8960_LOUT2, 0x70, 0);
            snd_soc_update_bits(codec, WM8960_ROUT2, 0x70, 0);
            /* Headphone */
            snd_soc_update_bits(codec, WM8960_LOUT1, 0x70, 0x70);
            snd_soc_update_bits(codec, WM8960_ROUT1, 0x70, 0x70);
